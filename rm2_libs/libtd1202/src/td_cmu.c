/***************************************************************************//**
 * @file
 * @brief CMU (Clock Management Unit) peripheral API for the TD1202 module.
...
/** @addtogroup CMU_PUBLIC_FUNCTIONS Public Functions
 * @{ */
