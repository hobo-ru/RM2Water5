...
#define TD_RTC_TICKS_PER_SECOND 1024
...
#define IRQ_PERIOD	32	// 32 per second //Tiffany power_meter

#endif
    
#ifdef WATER_METER
    
#define IRQ_PERIOD	64	// 16 per second //Tiffany water_meter
...
static uint32_t rtcOffsetTime = 1000000;
